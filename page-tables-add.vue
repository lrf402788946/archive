                            ...
                            <b-tab title="基本情况" :title-link-class="linkClass(0)">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="tyx-margin-right-40 form-group">
                                                    ...
                                                    <input type="text" class="form-control tyx-cursor"  id="enddate"  data-date-format="yyyy-mm-dd" readonly />
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="tyx-margin-right-40 form-group">
                                                    ...
                                                    <input type="text" class="form-control tyx-cursor" value="2012-04-05"  id="theTimeBegin"  data-date-format="yyyy-mm-dd" readonly />
                                                    <span class="input-group-addon">至</span>
                                                    <!-- <input name="event-end-date" type="text" class="form-control" value="2012-04-19"> -->
                                                    <input type="text" class="form-control tyx-cursor" value="2012-04-05"  id="theTimeEnd"  data-date-format="yyyy-mm-dd" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="tyx-margin-right-40 form-group">
                                                    ...
                                                    <input type="text" class="form-control tyx-cursor" id="partyTime" data-date-format="yyyy-mm-dd"  readonly />
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="tyx-margin-right-40 form-group">
                                                    <label for="exampleInputName2">出生日期：</label>
                                                    <input type="text" class="form-control tyx-cursor" id="begindateT" data-date-format="yyyy-mm-dd"  readonly />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="tyx-margin-right-40 form-group">
                                                    ...
                                                    <input type="text" class="form-control tyx-cursor" id="creationTime" data-date-format="yyyy-mm-dd" readonly />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div  class="base-padding-20 base-bg-fff" style="clear:both;"> 
                                    <div class="base-margin-top-10 base-align-right">
                                        <a class="btn btn-info" href="page-tables.html" data-toggle="tooltip" title="" role="button"><i class="base-margin-right-5 fa fa-hand-o-left "></i>返&nbsp;&nbsp;回</a>
                                        <a class="btn btn-info" href="page-tables.html" data-toggle="tooltip" title="" role="button"><i class="base-margin-right-5 fa fa-hand-o-right "></i>保&nbsp;&nbsp;存</a>
                                    </div> 
                                </div>
...
a.textLight:hover, a.textLight:focus {
color: #fff !important;
}
.bgPrimary {
