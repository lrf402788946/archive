                ...
                <div class="col-lg-12">
                    <div class="col-lg-6">
                        <div class="base-margin-right-40 form-group">
                            <div class="form-group">
                                <label for="exampleInputEmail1">例行谈话状况表：</label>
                            </div>
...
export default {
  ...
  methods: {
    ...
    async query() {
      ...
      let result = await this.$axios.get(`/jszx/jbqk/jbqk_detail?id=${this.$route.query.id}&type=3`);
